...
@interface TDExtensionSecurityPolicy ()
...
@implementation TDExtensionSecurityPolicy
...
+ (instancetype)defaultPolicy {
    TDExtensionSecurityPolicy *securityPolicy = [[self alloc] init];
...
- (instancetype)copyWithZone:(NSZone *)zone {
    TDExtensionSecurityPolicy *securityPolicy = [[[self class] allocWithZone:zone] init];
